      ...
      >
        <Grid item xs={8}>
          <Box sx={{
            ...
            <Typography className="text-center mx-auto text-xl font-bold mb-6 text-[#1f1f1f]
            sm:mb-12 sm:p-1 sm:px-5 sm:text-3xl">
              LIFF Project Shopping app
            </Typography>
            <Typography className="text-[#8e8e93] mx-auto text-xs text-center mb-6
        ...
        <Grid item xs={4}>
          ...
          <Typography className="text-center text-sm mx-auto text-[#1f1f1f]
